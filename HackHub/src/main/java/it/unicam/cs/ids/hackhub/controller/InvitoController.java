...
public class InvitoController {
    ...
    public ResponseEntity<String> creaInvito(@PathVariable Long idMittente, @RequestBody InvitoDTO invitoDTO) {
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body("Invito inviato con successo! ID Invito: " + nuovoInvito.getId());
    }
    ...
    public ResponseEntity<String> accettaInvito(@PathVariable Long idInvito) {
        ...
        return ResponseEntity.ok("Invito accettato con successo! L'utente e' entrato a far parte del team '" + teamAggiornato.getName() + "'.");
    }
